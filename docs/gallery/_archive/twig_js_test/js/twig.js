...
var Twig = (function (Twig) {
    ...
    Twig.Templates.loadRemote = function(location, params, callback, error_callback) {
        ...
        console.log("AJAX!!");
            ...
            xmlhttp.open("GET", location+"?rand="+Math.random(), async);
            xmlhttp.send();
    ...
    Twig.Template = function ( params ) {
        ...
        this.path   = path;
        this.url    = url;
        this.TEMPLATE_FOLDER = params.templateFolder;
        this.macros = macros;
    ...
    Twig.Template.prototype.render = function (context, params) {
        ...
        if (this.extend) {
            ...
            if (!ext_template) {
                url = relativePath(this, this.extend, params);
    ...
    Twig.Template.prototype.importFile = function(file) {
        ...
        console.log("THIS BASE:"+template.url);
     ...
     */
    function relativePath(template, file,params) {
        var base,
            base_path,
            sep_chr = "/",
            new_path = [],
        ...
        base_path = base.split(sep_chr);
          console.log("OLD BASE PATH:"+base_path);
        // Remove file from url
        base_path.pop();
        //ORIG
        // base_path = base_path.concat(file.split(sep_chr));
        //CMCM EDIT
        // base_path = base_path.concat(file.split(sep_chr).pop());
        //CMCM EDIT 2
       // var newFile = file.split(sep_chr);
       // newFile.shift();
       // base_path = base_path.concat(newFile);
        //CMCM EDIT 3
       //  var newFile = template.url.split(sep_chr);
       //  newFile.pop();
       // base_path = newFile;
        //CMCM EDIT 4
        ...
        //<--/EDIT
        //console.log(Twig);
        console.log("TEMPLATE_FOLDER:"+Twig.TEMPLATE_FOLDER);
       // console.log("STACK:", stack.length);
        ...
        console.log(file);
       console.log("MORE CRAP: "+base_path+" "+file+" "+new_path.join(sep_chr));
       	//ORIG
        //return new_path.join(sep_chr);
        //CMCM EDIT
        return (Twig.TEMPLATE_FOLDER+file);
    }
...
var Twig = (function (Twig) {
    ...
    Twig.exports = {
        ...
        TEMPLATE_FOLDER : Twig.TEMPLATE_FOLDER
    };
    ...
    Twig.exports.twig = function twig(params) {
        'use strict';
        Twig.TEMPLATE_FOLDER = params.templateFolder;
        var id = params.id,
            options = {
