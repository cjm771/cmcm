			...
			attributeTypes : {
				...
				timestamp : {
					...
					//	cmcm.edit("timestamp", dateString, cmcm.draft, "v");
					 	...
					 	input = $('<input class="form-control date_input" type="text" value="" readonly>');
				...
				text : {
					edit : function(obj){
						...
						*/
						ta =  $("<textarea class='form-control'></textarea>");
						ta.val(obj.value);
						if (obj.onChange){
		       ...
		       //file uploader
				fileInput.fileupload({
				    ...
				    fail : function(e, data){
			        	...
			        	//settingsButton.attr("id", "s-"+data.context.attr("data-id"));
			        	settingsWrapper.append(settingsButton);
			        	/*
			        	settingsMenu = $('  <ul class="dropdown-menu ">'+
				        	'<li class="input"><span class="header">Source:</span><input type="text"></li>'+
				            '<li class="input"><span class="header">Visible:</span><input type="checkbox"></li>'+
				            '<li class="divider"></li>'+
				            '<li class="input"><span class="header">Caption:</span><textarea></textarea></li>'+
				            '</ul>');
				       */
				       ...
				       $.each(that.draft.media[data.context.attr("data-id")], function(k,v){
							...
							if (!tmpl.hidden){
						       ...
						       sli.append('<span class="header">'+k+':</span>');
						       sli.append(val);
